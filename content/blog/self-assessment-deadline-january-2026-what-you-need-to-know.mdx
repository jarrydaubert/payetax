...
**Last Updated**: January 2026 | **Tax Year**: 2024-2025
...
| 28 February 2026 | Deadline to set up payment plan (if needed) |
...
- **Rental property income** above £2,500 (or any amount if claimed expenses)
- **Savings or investment income** above £10,000
- **Dividend income** above £10,000
- **Capital gains** above the annual exemption (£3,000 in 2024-25)
- **Foreign income** that needs reporting
- **Income over £100,000** (even as PAYE employee)
- **Child Benefit clawback** (High Income Child Benefit Charge)
- **Director of a company** (even if no income)
- **Partner in a business partnership**
- **Claiming tax relief** on pensions, charitable donations, or expenses

### You DON'T Need to File If:

- PAYE-only employee earning under £100,000
- No additional income sources
- No tax relief claims needed
...
**Plus**: Interest on unpaid tax (currently ~7.5% annually)
...
Maintain tax records for **at least 5 years** (6 years for self-employed).

HMRC can enquire into your return for up to 4 years (longer if they suspect fraud).
...
Most PAYE-only employees don't need to file. However, you must file if you earn over £100,000, claim tax relief not handled by your employer, or have untaxed income above £2,500.
...
- **Set up a payment plan** if you can't pay in full (apply by end of February)
- **Keep records for 5-6 years** in case of HMRC enquiry
