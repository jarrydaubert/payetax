...
imageAlt: "Budget papers, red update folder, desk calendar, calculator, pen, binder clips, and coin stacks on paper"
...
**High earners:** Those using salary sacrifice to maximise the annual pension allowance
...
**Plan:** Salary sacrifice still works for income tax relief, but the NICs exemption caps at £2,000 from 2029. Maximise ISAs and consider tax-efficient investments.
...
1. **Maximise ISA contributions** - £20,000 limit still applies, and returns are tax-free (unaffected by rate increases)
