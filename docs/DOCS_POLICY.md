...
- Exception: evidence records, dated reports, and release records can be time-bound.
...
- When an item is complete, remove it from backlog in the same change set that delivers the outcome and evidence.
