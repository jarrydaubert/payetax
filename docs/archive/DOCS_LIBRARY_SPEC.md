# Documentation Library (Archived Concept)

Comprehensive documentation library for UK tax concepts, tied to calculator inputs/outputs.
...
Implementation work for /docs lives in `docs/BACKLOG.md`.
