...
- [ ] Explicit ownership of pay-period conversion and rounding rules (factors, ceil/floor conventions, period scaling) in one place. DoD: one owner module; consumers import it; no duplicate factor tables remain.
