          ...
          },
          {
            ...
            value:
              process.env.NODE_ENV === 'development'
                ? "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://js.sentry-cdn.com https://va.vercel-scripts.com https://analytics.ahrefs.com https://giscus.app https://payetax.kit.com https://app.kit.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: https: blob:; font-src 'self' data: https:; connect-src 'self' https://www.google-analytics.com https://region1.google-analytics.com https://www.googletagmanager.com https://vitals.vercel-insights.com https://va.vercel-scripts.com https://*.ingest.sentry.io https://analytics.ahrefs.com https://vercel.live https://giscus.app https://payetax.kit.com https://app.kit.com https://api.kit.com; frame-src 'self' https://giscus.app https://payetax.kit.com https://app.kit.com; worker-src 'self' blob:; child-src 'self' https://payetax.kit.com https://app.kit.com; object-src 'none'; base-uri 'self'; form-action 'self' https://payetax.kit.com https://app.kit.com; frame-ancestors 'none';"
