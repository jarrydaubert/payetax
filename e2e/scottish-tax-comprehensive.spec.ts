...
test.describe('Scottish Tax - All 6 Tax Bands', () => {
  ...
  test('Scottish: £20k - Basic rate 20%', async ({ page }) => {
    ...
    await expect(page.getByTestId('salary-input')).toHaveValue('20000');
  ...
  test('Scottish: £35k - Intermediate rate 21%', async ({ page }) => {
    ...
    await expect(page.getByTestId('salary-input')).toHaveValue('35000');
  ...
  test('Scottish: £60k - Higher rate 42%', async ({ page }) => {
    ...
    await expect(page.getByTestId('salary-input')).toHaveValue('60000');
  ...
  test('Scottish: £100k - Advanced rate 45%', async ({ page }) => {
    ...
    await expect(page.getByTestId('salary-input')).toHaveValue('100000');
  ...
  test('Scottish: £200k - Top rate 48%', async ({ page }) => {
    ...
    await expect(page.getByTestId('salary-input')).toHaveValue('200000');
...
test.describe('Scottish Tax - Edge Cases', () => {
  test('Exactly at band boundaries', async ({ page }) => {
    ...
    await expect(page.getByTestId('salary-input')).toHaveValue('14876');
  ...
  test('£1 over band boundary triggers next rate', async ({ page }) => {
    ...
    await expect(page.getByTestId('salary-input')).toHaveValue('14877');
