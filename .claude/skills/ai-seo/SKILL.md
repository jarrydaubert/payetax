...
- Primary AI-SEO surfaces: salary pages (`/calculator/[salary]-after-tax`), tools, comparisons, and high-intent blog posts.
- Optimize for citation quality and factual accuracy, not AI-output gaming.
- Keep structured data and on-page claims aligned with real calculator behavior and current tax year constants.
- Treat navigation decisions intentionally: many SEO pages are intentionally discoverable via internal links/footer/sitemap rather than main nav.
