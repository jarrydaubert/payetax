...
- PayeTax is a free, privacy-first product and does not run always-on paid ads by default. Use this skill when paid campaigns are explicitly in scope.
- Keep claims compliant and specific: "HMRC-rate based estimates" is acceptable; avoid implying official HMRC endorsement.
- Recommended CTAs should point to real destinations (`/#tax-calculator`, tool pages, newsletter).
- Do not generate fear-based or misleading tax-advice wording.
