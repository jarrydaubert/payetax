...
- Core PayeTax product has no paid subscription or account cancellation flow today.
- Use this skill only when explicitly working on newsletter retention, re-engagement, or future paid offerings.
- Do not introduce subscription assumptions into baseline audits unless the user asks for future-state planning.
- For current-state product work, prioritize calculator completion and trust metrics over SaaS churn frameworks.
