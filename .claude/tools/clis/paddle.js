    ...
    case 'products':
      switch (sub) {
        ...
        case 'create': {
          ...
          if (!taxCategory) {
            result = { error: '--tax-category required (e.g. standard, digital-goods, saas)' };
            break;
          }
    ...
    case 'prices':
      switch (sub) {
        ...
        case 'create': {
          ...
          if (!amount) {
            result = { error: '--amount required (in lowest denomination, e.g. cents)' };
            break;
          }
          const body = {
    ...
    case 'transactions':
      switch (sub) {
        ...
        case 'create': {
          ...
          if (!items) {
            result = { error: '--items required (JSON array of {price_id, quantity})' };
            break;
          }
          let parsedItems;
          try {
    ...
    case 'discounts':
      switch (sub) {
        ...
        case 'create': {
          ...
          if (!type) {
            result = { error: '--type required (flat, flat_per_seat, percentage)' };
            break;
          }
          const body = {
            amount,
    ...
    case 'adjustments':
      switch (sub) {
        ...
        case 'create': {
          ...
          if (!items) {
            result = { error: '--items required (JSON array of {item_id, type, amount})' };
            break;
          }
          let parsedItems;
          try {
