      ...
      switch (sub) {
        ...
        case 'create': {
          ...
          if (args['estimated-duration'])
            payload.data.attributes.estimated_duration = Number(args['estimated-duration']);
        ...
        default:
          result = {
            error: 'Unknown events subcommand. Use: list, get, create, update, delete, people',
          };
      }
      break;
      ...
      switch (sub) {
        ...
        case 'create': {
          ...
          if (args['estimated-started-at'])
            payload.data.attributes.estimated_started_at = args['estimated-started-at'];
