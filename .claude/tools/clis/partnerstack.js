...
if (!(PUBLIC_KEY && SECRET_KEY)) {
  console.error(
    JSON.stringify({
      error: 'PARTNERSTACK_PUBLIC_KEY and PARTNERSTACK_SECRET_KEY environment variables required',
    }),
  );
  process.exit(1);
}
  ...
  switch (cmd) {
    ...
    case 'customers':
      switch (sub) {
        ...
        default:
          result = {
            error: 'Unknown customers subcommand. Use: list, get, create, update, delete',
          };
      }
      break;
