...
export const categoryContent: Record<string, CategoryContent> = {
  ...
  'salary-guides': {
    ...
    description:
      "Detailed breakdowns of what different salaries actually look like in the UK after tax, National Insurance, and other deductions. Our salary guides explain what you'll take home at various income levels, from graduate salaries to executive pay. Understand the real value of pay rises, bonuses, and salary bands with our comprehensive analysis. Each guide covers income tax calculations, NI contributions, student loan impact, pension considerations, and effective tax rates. Perfect for salary negotiations, job comparisons, and career planning. We break down common UK salaries like £25k, £30k, £40k, £50k, £60k, £75k, and £100k+ to show you the take-home pay and marginal rates. Learn how crossing tax thresholds affects your net income and identify key salary thresholds.",
    keywords: [
      'salary breakdown',
      'take-home pay',
      'after tax salary',
