...
export function calculateComparison(
  ...
  const niDiff = newResults.nationalInsurance.annually - currentResults.nationalInsurance.annually;
...
export function calculateMarginalRate(
  ...
  return {
    marginalRate: Math.max(0, Math.min(100, marginalRate)),
