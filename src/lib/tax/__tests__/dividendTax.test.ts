...
import { calculateDividendTax, getDividendTax, getEffectiveDividendRate } from '../dividendTax';

describe('Dividend Tax Calculator', () => {
  const LEGACY_TAX_YEAR = '2025-2026' as const;

  describe('calculateDividendTax', () => {
    describe('Dividend allowance', () => {
      it('should return 0 tax when dividends are within allowance', () => {
        const result = calculateDividendTax(500, 12570, LEGACY_TAX_YEAR);
      ...
      it('should return 0 tax when dividends are below allowance', () => {
        const result = calculateDividendTax(200, 12570, LEGACY_TAX_YEAR);
      ...
      it('should apply allowance before calculating tax', () => {
        const result = calculateDividendTax(1000, 12570, LEGACY_TAX_YEAR);
    ...
    describe('Basic rate band', () => {
      it('should calculate basic rate for dividends within basic band', () => {
        ...
        const result = calculateDividendTax(30000, 12570, LEGACY_TAX_YEAR);
      ...
      it('should tax all at basic rate when total income stays in basic band', () => {
        ...
        const result = calculateDividendTax(20000, 12570, LEGACY_TAX_YEAR);
    ...
    describe('Higher rate band', () => {
      it('should calculate higher rate when dividends push into higher band', () => {
        ...
        const result = calculateDividendTax(50000, 12570, LEGACY_TAX_YEAR);
      ...
      it('should split dividends between basic and higher rates correctly', () => {
        ...
        const result = calculateDividendTax(30000, 40000, LEGACY_TAX_YEAR);
    ...
    describe('Additional rate band', () => {
      it('should calculate additional rate for very high dividends', () => {
        ...
        const result = calculateDividendTax(150000, 12570, LEGACY_TAX_YEAR);
    ...
    describe('Band stacking', () => {
      it('should stack dividends on top of salary for band calculation', () => {
        ...
        const resultLowSalary = calculateDividendTax(10000, 40000, LEGACY_TAX_YEAR);
        const resultHighSalary = calculateDividendTax(10000, 60000, LEGACY_TAX_YEAR);
    ...
    describe('Edge cases', () => {
      it('should return 0 for zero dividends', () => {
        const result = calculateDividendTax(0, 50000, LEGACY_TAX_YEAR);
      ...
      it('should return 0 for negative dividends', () => {
        const result = calculateDividendTax(-1000, 50000, LEGACY_TAX_YEAR);
      ...
      it('should apply Personal Allowance to dividends when no other income', () => {
        ...
        const result = calculateDividendTax(30000, 0, LEGACY_TAX_YEAR);
      ...
      it('should shelter dividends with unused PA from low salary', () => {
        ...
        const result = calculateDividendTax(20000, 5000, LEGACY_TAX_YEAR);
      ...
      it('should round to pence correctly', () => {
        const result = calculateDividendTax(1234, 12570, LEGACY_TAX_YEAR);
      ...
      it('should handle NaN dividends gracefully', () => {
        const result = calculateDividendTax(Number.NaN, 12570, LEGACY_TAX_YEAR);
      ...
      it('should handle Infinity dividends gracefully', () => {
        const result = calculateDividendTax(Number.POSITIVE_INFINITY, 12570, LEGACY_TAX_YEAR);

        expect(result.dividendTax).toBe(0);
      });

      it('should handle NaN salary gracefully', () => {
        const result = calculateDividendTax(50000, Number.NaN, LEGACY_TAX_YEAR);
    ...
    describe('Director scenario (golden examples)', () => {
      it('should calculate correctly for typical Baseline Mix (£12,570 salary + dividends)', () => {
        ...
        const result = calculateDividendTax(52000, 12570, LEGACY_TAX_YEAR);
      ...
      it('should calculate correctly for All Dividends strategy (£0 salary)', () => {
        ...
        const result = calculateDividendTax(77250, 0, LEGACY_TAX_YEAR);
      ...
      it('should apply PA taper for high income (£100k+ total)', () => {
        ...
        const result = calculateDividendTax(110000, 0, LEGACY_TAX_YEAR);
      ...
      it('should fully taper PA at £125,140+ total income', () => {
        ...
        const result = calculateDividendTax(150000, 0, LEGACY_TAX_YEAR);
      ...
      it('should not taper PA when total income below £100k', () => {
        ...
        // PA should NOT taper
        const result = calculateDividendTax(80000, 0, LEGACY_TAX_YEAR);
  ...
  describe('getDividendTax (convenience function)', () => {
    it('should return just the tax amount', () => {
      expect(getDividendTax(500, 12570, LEGACY_TAX_YEAR)).toBe(0); // Within allowance
      expect(getDividendTax(30000, 12570, LEGACY_TAX_YEAR)).toBeGreaterThan(0);
    });
  });

  describe('getEffectiveDividendRate', () => {
    it('should return correct effective rate', () => {
      expect(getEffectiveDividendRate(500, 12570, LEGACY_TAX_YEAR)).toBe(0); // Within allowance
      expect(getEffectiveDividendRate(30000, 12570, LEGACY_TAX_YEAR)).toBeGreaterThan(0);
    });

    it('should return rate between 0 and additional rate', () => {
      const rate = getEffectiveDividendRate(50000, 12570, LEGACY_TAX_YEAR);
  ...
  describe('DIVIDEND_RATES constants', () => {
    it('should expose the live current-year dividend rates', () => {
      expect(TAX_RATES[CURRENT_TAX_YEAR].dividendAllowance).toBe(500);
      expect(DIVIDEND_RATES.BASIC_RATE).toBe(0.1075);
      expect(DIVIDEND_RATES.HIGHER_RATE).toBe(0.3575);
      expect(DIVIDEND_RATES.ADDITIONAL_RATE).toBe(0.3935);
    });

    it('should preserve 2025-26 dividend rates for historical calculations', () => {
      expect(DIVIDEND_TAX_RATES['2025-2026'].BASIC_RATE).toBe(0.0875);
      expect(DIVIDEND_TAX_RATES['2025-2026'].HIGHER_RATE).toBe(0.3375);
      expect(DIVIDEND_TAX_RATES['2025-2026'].ADDITIONAL_RATE).toBe(0.3935);
    });
  });
});
