...
const parityCases: Array<{
  ...
  },
  {
    ...
    expected: {
      ...
      incomeTaxAnnually: 8_227.92,
      nationalInsuranceAnnually: 3_050.04,
      studentLoanAnnually: 0,
      pensionContributionAnnually: 0,
      employerNI: 7_049.4,
      netPayAnnually: 40_722.03999999999,
      netPayMonthly: 3_393.503333333333,
    },
  },
  {
  ...
  },
  {
    ...
    expected: {
      ...
      taxFreeAmount: 12_570,
      taxableIncome: 32_412,
      incomeTaxAnnually: 6_930.84,
      nationalInsuranceAnnually: 3_728.7599999999998,
      studentLoanAnnually: 0,
      pensionContributionAnnually: 0,
      employerNI: 4_954.8,
      netPayAnnually: 34_340.399999999994,
      netPayMonthly: 2_861.7,
    },
  },
  {
    ...
    expected: {
      ...
      incomeTaxAnnually: 44_273.76,
      nationalInsuranceAnnually: 4_410,
      studentLoanAnnually: 0,
      pensionContributionAnnually: 0,
      employerNI: 15_304.8,
      netPayAnnually: 71_316.24,
      netPayMonthly: 5_943.02,
    },
  },
  {
    ...
    expected: {
      ...
      incomeTaxAnnually: 9_427.92,
      nationalInsuranceAnnually: 3_110.04,
      studentLoanAnnually: 0,
      pensionContributionAnnually: 0,
      employerNI: 7_499.4,
      netPayAnnually: 42_462.03999999999,
      netPayMonthly: 3_538.503333333333,
    },
  },
  {
    name: '2026-27 K-code',
    ...
    expected: {
      ...
      incomeTaxAnnually: 8_861.52,
      nationalInsuranceAnnually: 2_193.96,
      studentLoanAnnually: 0,
      pensionContributionAnnually: 0,
      employerNI: 5_249.4,
      netPayAnnually: 28_944.520000000004,
      netPayMonthly: 2_412.0433333333335,
    },
  },
  {
    ...
    expected: {
      ...
      incomeTaxAnnually: 27_432.72,
      nationalInsuranceAnnually: 4_010.04,
      studentLoanAnnually: 0,
      pensionContributionAnnually: 10_000,
      employerNI: 15_749.88,
      netPayAnnually: 68_560.23999999999,
      netPayMonthly: 5_713.353333333333,
    },
  },
  {
    ...
    expected: {
      ...
      incomeTaxAnnually: 12_226.32,
      nationalInsuranceAnnually: 3_129.96,
      studentLoanAnnually: 1_452,
      pensionContributionAnnually: 2_400,
      employerNI: 8_009.4,
      netPayAnnually: 45_191.72000000001,
      netPayMonthly: 3_765.9766666666674,
      incomeBreakdown: {
        employment: 58_400,
        nonEmployment: 6_000,
        total: 64_400,
