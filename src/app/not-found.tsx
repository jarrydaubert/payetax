    ...
    <div className='relative flex min-h-screen items-center justify-center overflow-hidden pt-20'>
      ...
      <div className='relative z-10 mx-auto max-w-6xl px-4 text-center'>
        ...
        <div className='mb-12 grid grid-cols-1 gap-6 md:grid-cols-3'>
          ...
          >
            <Home
              className={`mx-auto mb-4 ${ICON_SIZES.SIZE_8} text-primary transition-colors group-hover:text-primary/80`}
              aria-hidden='true'
            />
            ...
            <ArrowRight
              className={`mx-auto mt-3 ${ICON_SIZES.SIZE_4} text-primary transition-transform group-hover:translate-x-1`}
              aria-hidden='true'
            />
          </Link>
          ...
          >
            <Calculator
              className={`mx-auto mb-4 ${ICON_SIZES.SIZE_8} text-cyan-500 transition-colors group-hover:text-cyan-400`}
              aria-hidden='true'
            />
            ...
            <ArrowRight
              className={`mx-auto mt-3 ${ICON_SIZES.SIZE_4} text-cyan-500 transition-transform group-hover:translate-x-1`}
              aria-hidden='true'
            />
          </Link>
          ...
          >
            <FileText
              className={`mx-auto mb-4 ${ICON_SIZES.SIZE_8} text-pink-500 transition-colors group-hover:text-pink-400`}
              aria-hidden='true'
            />
            ...
            <ArrowRight
              className={`mx-auto mt-3 ${ICON_SIZES.SIZE_4} text-pink-500 transition-transform group-hover:translate-x-1`}
              aria-hidden='true'
            />
          </Link>
        </div>
        ...
        <div className='glass-card mb-8 rounded-xl border border-border p-8'>
          <h3 className='mb-4 flex items-center justify-center gap-2 font-semibold text-foreground text-xl'>
            <Coffee
              className={`${ICON_SIZES.SIZE_5} text-yellow-500 dark:text-yellow-400`}
              aria-hidden='true'
            />
            Did You Know?
          </h3>
