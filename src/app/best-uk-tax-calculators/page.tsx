          ...
          <div className={cn('grid gap-6 md:grid-cols-2 lg:grid-cols-4', SPACING.MT_8)}>
            <Card className={cn(SURFACES.CARD_STANDARD, 'text-center')}>
              ...
              <p className={cn('text-muted-foreground', TYPOGRAPHY.TEXT_SM, SPACING.MB_4)}>
                Need fast results without distractions?
              </p>
              <p className={cn('font-semibold text-primary', TYPOGRAPHY.TEXT_SM)}>→ Use PayeTax</p>
            </Card>
            ...
            <Card className={cn(SURFACES.CARD_STANDARD, 'text-center')}>
              ...
              <h3 className={cn('font-bold', TYPOGRAPHY.TEXT_LG, SPACING.MB_2)}>Self-Assessment</h3>
              <p className={cn('text-muted-foreground', TYPOGRAPHY.TEXT_SM, SPACING.MB_4)}>
                Filing your own tax return?
              </p>
              <p className={cn('font-semibold text-amber-600', TYPOGRAPHY.TEXT_SM)}>→ Use GOV.UK</p>
            </Card>
          ...
          <div className={cn(SPACING.MT_8, SPACING.SPACE_Y_6)}>
            <Card className={SPACING.P_6}>
              ...
              <p className='text-muted-foreground'>
                All reputable calculators (PayeTax, GOV.UK, MSE, The Salary Calculator) use the same
                official HMRC rates and should give identical results for standard PAYE
                calculations. The main differences are in user experience, speed, and additional
                features like What-If comparisons.
              </p>
            </Card>
            ...
            <Card className={SPACING.P_6}>
              ...
              <p className='text-muted-foreground'>
                PayeTax is the only UK tax calculator with What-If salary comparison scenarios,
                allowing you to instantly compare different salary amounts. It&apos;s also 100%
                ad-free, privacy-first (all calculations happen in your browser), and designed
                mobile-first for the best experience on any device.
              </p>
            </Card>
            ...
            <Card className={SPACING.P_6}>
              ...
              <p className='text-muted-foreground'>
                ...
                purposes. However, for quick PAYE salary calculations, modern calculators like
                PayeTax offer a faster, cleaner experience with real-time results and better mobile
                support.
              </p>
            </Card>
