...
function isAuthorized(request: NextRequest): boolean {
  ...
  if (IS_PRODUCTION) {
    ...
    return secretMatches(
      request.headers.get('x-rate-limit-health-secret'),
  ...
  return secretMatches(request.headers.get('x-rate-limit-health-secret'), RATE_LIMIT_HEALTH_SECRET);
}
