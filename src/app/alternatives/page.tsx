            ...
            <div className={cn('grid gap-6 md:grid-cols-3', SPACING.MT_8)}>
              <Card className={cn(SPACING.P_6, 'text-center')}>
                ...
                <p className='text-muted-foreground'>
                  Pop-ups, banners, and intrusive ads that slow everything down and distract from
              ...
              <Card className={cn(SPACING.P_6, 'text-center')}>
                ...
                <p className='text-muted-foreground'>
                  Multiple page loads, poor mobile experience, and interfaces that feel stuck in
                  2010.
                </p>
              </Card>
              ...
              <Card className={cn(SPACING.P_6, 'text-center')}>
                ...
                <p className='text-muted-foreground'>
                  Worried about who&apos;s tracking your salary data and what they&apos;re doing
                  with it.
                </p>
              </Card>
            </div>
